...
def library(request):
    ...
    # num_fantasy = Genre.objects.filter(name__iexact='fantasy').count()
    # num_boopie = Book.objects.filter(title__iexact='Boopie goes on vacation').count()
...
class LoanedBooksListView(PermissionRequiredMixin,generic.ListView):
    """Generic class-based view listing books on loan to all_users."""
    model = BookInstance
